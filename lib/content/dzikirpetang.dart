...
class DzikiPetangScreen extends StatelessWidget {
  ...
  DzikiPetangScreen({required this.doaNumber});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 255, 245, 237),
      appBar: Header(title: 'Dzikir Petang', imagePath: 'assets/icon/quran.png'),
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text(dzikir.arabic, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
                          SizedBox(height: 2),
